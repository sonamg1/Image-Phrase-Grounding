...
if __name__ == "__main__":
	...
	parser.add_argument("--data_path", type=str, default="/Users/david/desktop/CV_research/VQA/dataset")
	parser.add_argument("--data_name", type=str, default="")
	parser.add_argument("--max_ques", type=int, default=14)
	parser.add_argument("--max_ans", type=int, default=None)
	parser.add_argument("--glove_path", type=str, default="/Users/david/desktop/CV_research/VQA/dataset/glove_840B.pt")
